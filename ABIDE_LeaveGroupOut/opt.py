...
class OptInit():
    def __init__(self):
        ...
        parser.add_argument('--subject_IDs_path', type=str, default='/mnt/test_data/ABIDE_pcp/subject_IDs.txt', help='the path of the subject_IDs')
        parser.add_argument('--phenotype_path', type=str, default=r"/mnt/test_data/ABIDE_pcp/Phenotypic_V1_0b_preprocessed1.csv", help='the path of the phenotype data')
        parser.add_argument('--data_path', type=str, default=r'/mnt/test_data/ABIDE_pcp/cpac/filt_noglobal',help='the path of the data')
